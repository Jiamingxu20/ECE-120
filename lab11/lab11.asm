...
; R5 contains current sum
            ...
            AND   R1,R1,#0            ; Clear R1 (previous sum) to 0
            AND   R2,R2,#0            ; Clear R2 (previous sum) to 0
            AND   R3,R3,#0            ; Clear R3 (previous sum) to 0
            AND   R4,R4,#0            ; Clear R4 (previous sum) to 0
